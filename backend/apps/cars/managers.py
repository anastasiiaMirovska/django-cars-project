...
class CarManager(models.Manager):
    ...
    def average_price_statistics(self, car):
        ...
        average_price = cars.aggregate(Avg('price__price_in_UAH'))['price__price_in_UAH__avg']
    ...
    def average_city_price_statistics(self, car):
        car_is_used = car.is_used
        car_model = car.car_model_id
        city = car.profile.city

        cars = self.filter(car_model_id=car_model, is_used=car_is_used, profile__city=city).exclude(pk=car.id)
        average_price = cars.aggregate(Avg('price__price_in_UAH'))['price__price_in_UAH__avg']
        return average_price
